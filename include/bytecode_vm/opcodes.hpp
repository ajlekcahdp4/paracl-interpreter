...
enum opcode : std::uint8_t {
  ...
  E_PRINT_NULLARY, E_PUSH_READ_NULLARY, E_MOV_LOCAL_UNARY, E_MOV_LOCAL_REL_UNARY,
  E_PUSH_LOCAL_UNARY, E_PUSH_LOCAL_REL_UNARY, E_PUSH_LOCAL_DYNAMIC_REL_NULLARY, E_PUSH_LOCAL_REL_TOP_UNARY,
  ...
  E_PUSH_SP_NULLARY, E_UPDATE_SP_UNARY, E_LOAD_R0_NULLARY, E_STORE_R0_NULLARY,
};
// clang-format on
