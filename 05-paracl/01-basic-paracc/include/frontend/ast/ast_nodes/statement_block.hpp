...
public:
  ...
  statement_block(std::vector<i_ast_node_uptr> &&vec) : m_statements{std::move(vec)} {}
...
static inline i_ast_node_uptr make_statement_block(std::vector<i_ast_node_uptr> &&vec) {
